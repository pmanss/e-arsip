...
<div class="card shadow">
    <div class="card-body">
                  ...
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $total_arsips }}</div>
                      </div>
                      <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-warning shadow h-100 py-2">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-uppercase mb-1">Sampah Arsip</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $total_trashs }}</div>
                      </div>
                      <div class="col-auto">
        ...
        <div class="table-responsive">
            <p class="mb-2 mt-4 text-center"><b> Arsip Terbaru</b></p>
            <table class="table table-nowrap" id="dataTable">
                ...
                <tbody>
                    @forelse ($arsips_terbaru as $arsip)
                        <tr>
